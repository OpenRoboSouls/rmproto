...
// 选手端小地图接收雷达数据
const CmdRadarMessage int64 = 0x0305

// 自定义控制器与选手端交互数据
const CmdCustomControllerUpstreamMessage int64 = 0x0306

// 选手端小地图接收路径数据
const CmdMapPathMessage int64 = 0x0307

// 选手端小地图接收机器人数据
const CmdMapRobotMessage int64 = 0x0308

// 自定义控制器接收机器人数据
const CmdCustomControllerDownstreamMessage int64 = 0x0309
